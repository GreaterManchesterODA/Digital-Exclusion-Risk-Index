...
## Introduction
Version 1.0 of the Digital Exclusion Risk Index (DERI) tool is an online series of Tableau dashboards that aim to highlight the risk of digital exclusion at a lower super output area geography. These notes represent some of the considerations, calculations and decisions relating to the creation of version 1.0 of the tool. It is designed to complement both the [methodology document](DERI%20Score%20Methodology_v1.md) and the [Tableau develeopment document](Tableau%20development_v1.md) in this repository. It highlights important considerations for this version of the tool, and the divergences from the original tool developed by Salford on which this tool is based.
