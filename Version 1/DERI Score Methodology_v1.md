...
[There are 9 individual indicators that make up the overall DERI score.](Data sources_v1.md) These are individually weighted to form the next part in the calculation chain, the component scores. We have created a data scources list that can be used to create the datasets and scores.
