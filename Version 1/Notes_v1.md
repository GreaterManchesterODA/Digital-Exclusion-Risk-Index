...
## Data inclusion
The data used is that indicated in the [data sources document](Data%20sources_v1.csv). That includes:
...
> **DECISION:** Version 1 will not include an activity component, and therefore diverges from the original Salford approach. Notes for this are available in our [methodology document](DERI%20Score%20Methodology_v1.md).
